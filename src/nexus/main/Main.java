...
public class Main {
	...
	public static final String WINDOW_TITLE = "Cities";
	public static final int INIT_RENDER_DISTANCE = 6;
	public static final Vector3 INIT_CAMERA_POSITION = new Vector3(216.42438f, 38.29342f, -83.772194f);
	...
	public static void main(String[] argv) {
		...
		Model world = new Model(new Camera(INIT_CAMERA_POSITION, -0.405f, -1.88f, INIT_SENSITIVITY, CAMERA_INVERT));
